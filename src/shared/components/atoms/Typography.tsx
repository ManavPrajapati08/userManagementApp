...
interface TypographyProps {
  variant?: "h1" | "h2" | "h3" | "p" | "small" | "label" | "span";
  className?: string;
  children: ReactNode;
  id?: string;
}

const Typography = ({ variant = "p", className = "", children, id }: TypographyProps) => {
  const variants = {
  ...
  const Component = (variant === "label" ? "label" : variant === "span" ? "span" : variant.startsWith("h") ? variant : "p") as "h1" | "h2" | "h3" | "p" | "label" | "span";
